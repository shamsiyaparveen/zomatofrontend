...
export default class Wallpaper extends Component {
    ...
    constructor(){
      ...
      componentDidMount(){
          ...
          //call my api 
          fetch('https://zomatobackend123.herokuapp.com/zomato/locations',{method:'GET'})
      ...
      fetchRestaurants = (event)=>{
          fetch(`https://zomatobackend123.herokuapp.com/zomato/restaurants/${event.target.value}`,{method:'GET'})
          .then(response=>response.json())
